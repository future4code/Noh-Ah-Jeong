...
exports.selectPostById = exports.insertPost = void 0;
...
const insertPost = (post) => __awaiter(void 0, void 0, void 0, function* () {
    yield connection_1.connection.raw(`
        INSERT INTO ${postsTableName} (id, photo, description, type, createdAt, authorId)
        VALUES ("${post.id}", "${post.photo}", "${post.description}", "${post.type}", "${post.createdAt}", "${post.authorId}");
    `);
});
exports.insertPost = insertPost;
const selectPostById = (id) => __awaiter(void 0, void 0, void 0, function* () {
