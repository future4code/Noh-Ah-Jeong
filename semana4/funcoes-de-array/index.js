...
function filtrarDespesas(){
    ...
    if (tipoFiltro !== "" && valorMin >= 0 && valorMax >= 0 && valorMin < valorMax) {
        ...
        alert("`Faltou algum valor ou algum valor é um número negativo ou o valor mínimo é maior que o valor máximo`")
    }
}
